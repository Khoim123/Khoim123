-- Blox Fruits FPS Booster v4.1 - Fixed & Optimized Version
-- Giữ 100% skin player, tối ưu hiệu suất và memory

local success, err = pcall(function()
    print("=== FPS Booster v4.1 Starting (Fixed & Optimized) ===")
    ...
    -- FIXED: Hàm đếm phần tử cho dictionary thay cho table.getn đã lỗi thời
    ...
    -- IMPROVED: Hàm chờ LocalPlayer một cách an toàn
    local LocalPlayer
    ...
    -- IMPROVED: Tạo tag duy nhất cho mỗi lần chạy để tránh xung đột
    local TAG = "OptimizedFPS_v4_" .. tick()

    -- IMPROVED: Cache player characters và tự động dọn dẹp
    local function updatePlayerCache()
        -- Dọn dẹp các character đã bị hủy khỏi cache
        ...
        -- Thêm các character hiện tại vào cache
    ...
    local function applyBoost()
        ...
        state.gcConnection = task.spawn(function()
            while state.boosted do
                ...
                -- IMPROVED: Cập nhật và dọn dẹp player cache định kỳ
                updatePlayerCache()
            end
        end)
    ...
    LocalPlayer.Chatted:Connect(function(msg)
        ...
        -- FIXED: Sử dụng hàm countDictionary mới
